...
SCHEMA_PATH = st.secrets.get("SCHEMA_PATH", "OSCAR_MOVIE_DATABASE.OSCAR_MOVIE_SCHEMA")
QUALIFIED_TABLE_NAME = f"{SCHEMA_PATH}.OSCAR_AWARDED_MOVIES"
TABLE_DESCRIPTION = """
...
METADATA_QUERY = f"SELECT VARIABLE_NAME, DEFINITION FROM {SCHEMA_PATH}.MOVIE_ATTRIBUTES;"
